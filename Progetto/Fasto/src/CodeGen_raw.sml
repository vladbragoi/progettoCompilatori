...
fun compileExp e vtable place =
  ...
  *)
  ...
  | And (e1, e2, pos) =>
      let val b1 = newName "and_L"
          val b2 = newName "and_R"
          val code1 = compileExp e1 vtable b1
          val code2 = compileExp e2 vtable b2
          val falseLabel = newName "and_false"
      in code1 @ code2 @ 
          [Mips.BEQ (b1,b2, place)
          , Mips.J falseLabel ]
      end
  (*
